...
public class webStraktorSAX {
	...
	//---------------------------------------------------------------------------------
	{
	  ...
	  try {
	    ...
	    for (Method m : allMethods) {
			...
			try {
				//System.out.println("trying"+mname+sTag+sContent);
			    m.setAccessible(true);
			    Object o = m.invoke(CallingClass, sTag , sContent , sHier);
			    return true;
			    //System.out.println("returned " + mname +(Boolean) o);
	...
	//---------------------------------------------------------------------------------
	{
		...
		sTwee = xstrutl.RemplaceerNEW(sTwee,"\" ","\n")+"\n";   //  "spatie naar \n
		sTwee = xstrutl.RemplaceerNEW(sTwee,"\"", "");          //  " weg
	...
	//
	//---------------------------------------------------------------------------------
	boolean ParseXMLFile(String FNaam)
	//---------------------------------------------------------------------------------
	{
		logit("Parsing [" + FNaam + "]");
